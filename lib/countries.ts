...
// Pays par défaut pour Rampes Gardex
export const DEFAULT_COUNTRY = "Canada";

// Pays fréquemment utilisés (en haut de la liste)
...
// Fonction pour obtenir la liste complète avec pays fréquents en premier
export const getCountriesWithFrequent = () => {
  const otherCountries = countries.filter(
    c => !frequentCountries.find(f => f.code === c.code)
  );
  return [...frequentCountries, { code: "---", name: "──────────" }, ...otherCountries];
};